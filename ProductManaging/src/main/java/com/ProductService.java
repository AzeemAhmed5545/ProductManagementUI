...
public class ProductService {
	...
	public String insertItem(@FormParam("productID") String productID, @FormParam("sellerName") String sellerName,
			@FormParam("productprice") String productprice, @FormParam("productDesc") String productDesc) {
